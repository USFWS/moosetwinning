...
This is a function developed to generate a Quarto report that summarizes annual moose twinning results. It relies on many of the above functions for importing, formatting, analyzing, and generating tables and figures. After import and formatting your data (`dat`) following the steps above, simply run:
